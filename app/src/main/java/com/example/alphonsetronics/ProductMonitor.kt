...
class ProductMonitor : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_product_monitor)
        ...
        btnAddToCart.setOnClickListener {
            Toast.makeText(this, "Acer Nitro VG240Y added to cart!", Toast.LENGTH_SHORT).show()
        }
    }
}