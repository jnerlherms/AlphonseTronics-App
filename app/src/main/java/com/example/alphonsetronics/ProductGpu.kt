...
class ProductGpu : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_product_gpu)
        ...
        btnAddToCart.setOnClickListener {
            Toast.makeText(this, "Colorful RTX 5060 added to cart!", Toast.LENGTH_SHORT).show()
        }
    }
}